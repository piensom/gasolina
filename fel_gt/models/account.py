            ...
            if tipo_documento_fel in ['NDEB', 'NCRE'] or tipo_documento_fel in ['FCAM'] or (tipo_documento_fel in ['FACT', 'FCAM'] and factura.tipo_gasto == 'importacion') or tipo_documento_fel in ['FESP']:
                ...
                if tipo_documento_fel in ['NDEB', 'NCRE']:
                    ...
                    if factura.reversed_entry_id.numero_fel:
                        ...
                        ReferenciasNota = etree.SubElement(Complemento, CNO_NS+"ReferenciasNota", FechaEmisionDocumentoOrigen=str(factura.pos_order_ids.pedido_origen_id.account_move.invoice_date), MotivoAjuste="-", NumeroAutorizacionDocumentoOrigen=factura.pos_order_ids.pedido_origen_id.account_move.firma_fel, NumeroDocumentoOrigen=factura.pos_order_ids.pedido_origen_id.account_move.numero_fel, SerieDocumentoOrigen=factura.pos_order_ids.pedido_origen_id.account_move.serie_fel, Version="0.0", nsmap=NSMAP_REF)
